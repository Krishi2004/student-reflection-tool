            ...
            <form action="{{ route('reflection.update', $reflection->id) }}" method="POST">
                ...
                <div class="grid grid-cols-2 gap-4 mb-4">
                    <div>
                        ...
                        <input type="text" name="title" value="{{ old('title', $goal->title ?? '') }}" class="w-full rounded border-gray-300 @error('title') border-red-500 @enderror">
                ...
                <div class="space-y-3 mb-4">
                    <div>
                        <label class="block text-sm font-bold text-gray-700">Target Score</label>
                        <textarea  name="target_score" rows="2" required class="w-full rounded border-gray-300" placeholder="Context...">{{ old('target_score', $goal->target_score ?? '') }}</textarea>

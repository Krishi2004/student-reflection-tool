...
<div class="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
    ...
    <div style="width:500px;text-align: center">
        ...
        <div class="flex space-x-4 justify-center items-center" >
            <a href="{{ route('register') }}" class="bg-indigo-600 text-white text-lg px-8 py-3 rounded-xl hover:bg-indigo-700 transition duration-150 shadow-lg font-bold">
                Get Started Now
            </a>
        </div>
    </div>
    ...
    <div class="grid grid-cols-2 gap-4 mt-8">
        <div class="border border-indigo-600 rounded-md p-8 text-2xl max-w-xl">
            <div>
                ...
                <span class="text-xl block mt-2">Use frameworks like STAR and Gibbs to ensure your self-analysis is structured, measurable, and leads to valuable data.</span>
            </div>
...
<div class="grid grid-cols-3 gap-4 mt-8">
    <div>
        ...
        <span class="text-base block mt-1">Define a measurable goal (e.g., Raise 'Leadership' to 4.5/5) and break it into actionable steps. This starts your tracking process.</span>
    </div>
    <div>
        ...
        <span class="text-base block mt-1">Document a specific event, score your performance, and send a secure link to a supervisor for external validation. This eliminates self-bias.</span>
    </div>
    <div>
        <span class="text-6xl font-bold font-mono block">3</span>
        <span class="text-xl font-semibold block mt-2">Analyse & Level Up</span>
        <span class="text-base block mt-1">View your verified progress on the dashboard, track your consistency, and receive targeted advice to master your goal.</span>
    </div>
</div>
</section>

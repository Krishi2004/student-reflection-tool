...
<body>
    <!-- HERO SECTION: Edge-to-Edge Darkened Rectangle -->
    <section class="w-full h-100 dark:bg-gray-900 text-white py-16 md:py-24">
        ...
        <div class="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div style="width:500px;text-align: center">
                <b style="font-bold;font-size:160%">
                    Track your learning,
                    build your future
                </b>
                <br>
                <br>
                <p>
                    Move beyond grades. Our web-based tool uses
                    structured reflection and supervisor verification
                    to help you identify weaknesses, set goals, and
                    build a high-confidence portfolio of your essential
                    transferable skills
                </p>
                <br>
                <div class="flex space-x-4 justify-center items-center">
                    <a href="{{ route('register') }}"
                        class="bg-indigo-600 text-white text-lg px-8 py-3 rounded-xl hover:bg-indigo-700 transition duration-150 shadow-lg font-bold">
                        Get Started Now
                    </a>
                </div>
            </div>
            ...
            <div
                class="lg:col-span-1 flex items-center justify-right p-6 bg-gray-800 rounded-xl shadow-2xl min-h-[300px]">
    ...
    <section class="py-16 md:py-24 flex flex-col justify-center items-center">
        <p style="font-size:50px;text-align:center;">Why Choose Us</p>
        <p style="font-size:20px;text-align:center;">Structured reflection, clear results</p>
        <div class="grid grid-cols-2 gap-4 mt-8">
            <div class="border border-indigo-600 rounded-md p-8 text-2xl max-w-xl">
                <div>
                    <span class="text-xl font-bold block">Structured Reflections</span>
                    <span class="text-xl block mt-2">Use frameworks like STAR and Gibbs to ensure your self-analysis is
                        structured, measurable, and leads to valuable data.</span>
                </div>
            ...
            <div class="border border-indigo-600 rounded-md p-8 text-2xl max-w-xl">
                <div>
                    ...
                    <span class="text-xl block mt-2">Eliminate self-assessment bias. Get external, high-confidence
                        validation on your scores from supervisors or peers.</span>
                </div>
            ...
            <div class="border border-indigo-600 rounded-md p-8 text-2xl col-span-2 mx-auto max-w-xl">
                <div>
                    ...
                    <span class="text-xl block mt-2">Turn analytics into action. Receive personalised, automated advice
                        and actionable steps tailored exactly to your verified skill gaps and target goals</span>
                </div>
            </div>
    ...
    <section class="py-8">
        <p style="font-size:50px;text-align:center;">How It Works</p>
        <div class="grid grid-cols-3 gap-4 mt-8">
            <div>
                <span class="text-6xl font-bold font-mono block">1</span>
                <span class="text-xl font-semibold block mt-2">Plan Your Skill Target</span>
                <span class="text-base block mt-1">Define a measurable goal (e.g., Raise 'Leadership' to 4.5/5) and
                    break it into actionable steps. This starts your tracking process.</span>
            </div>
            <div>
                <span class="text-6xl font-bold font-mono block">2</span>
                <span class="text-xl font-semibold block mt-2">Reflect & Get Verified </span>
                <span class="text-base block mt-1">Document a specific event, score your performance, and send a secure
                    link to a supervisor for external validation. This eliminates self-bias.</span>
            </div>
            <div>
                <span class="text-6xl font-bold font-mono block">3</span>
                <span class="text-xl font-semibold block mt-2">Analyse & Level Up</span>
                <span class="text-base block mt-1">View your verified progress on the dashboard, track your consistency,
                    and receive targeted advice to master your goal.</span>
            </div>
        </div>
    </section>

    <div class="flex space-x-4 justify-center items-center mt-8">
        <a href="{{ route('register') }}"
            class="bg-indigo-600 text-white text-lg px-8 py-3 rounded-xl hover:bg-indigo-700 transition duration-150 shadow-lg font-bold">
            Get Started Now
        </a>
    ...
    <section class="w-full h-25 dark:bg-gray-900 text-white py-16 md:py-24">
        <footer>
            <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div class="max-w-3xl mx-auto">
                    <div class="flex space-x-10 justify-center items-center mb-14">
                        <a href="#" class="block  text-white-900 transition-all duration-500 hover:text-indigo-600 ">
                            <svg class="w-[1.688rem] h-[1.688rem]" xmlns="http://www.w3.org/2000/svg"
                    ...
                    <span class="text-lg text-gray-500 text-center block">©<a href="https://pagedone.io/">Level Up</a>

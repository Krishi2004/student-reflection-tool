...
<body class="bg-gray-100">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div
            class="relative bg-white rounded-3xl p-8 shadow-sm border border-gray-200 mb-8 overflow-hidden transition hover:shadow-md duration-300">
            <div
                class="absolute top-0 right-0 -mt-16 -mr-16 w-64 h-64 bg-indigo-50 rounded-full blur-3xl opacity-70 pointer-events-none">
            </div>
            <div
                class="absolute bottom-0 left-0 -mb-16 -ml-16 w-48 h-48 bg-purple-50 rounded-full blur-3xl opacity-70 pointer-events-none">
            </div>
            ...
            <div class="relative z-10 flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
                ...
                <a href="{{ route('reflection') }}"
                    class="shrink-0 group inline-flex items-center justify-center px-8 py-4 text-base font-black rounded-2xl text-white bg-indigo-600 hover:bg-indigo-700 shadow-lg hover:shadow-indigo-500/30 transition-all transform hover:-translate-y-1">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                        ...
                        @if($recentReflections->isEmpty())
                            <div class="text-center py-10">
                                ...
                                <p class="text-gray-500 text-sm mb-4">Start tracking your skill development by logging your
                                    first entry.</p>
                                <a href="{{ route('reflection') }}"
                                    class="text-indigo-600 font-bold hover:text-indigo-800 transition">Log your first
                                    reflection
                                    &rarr;</a>
                            </div>
                        @else
            ...
            <div class="flex flex-col gap-6">
                ...
                <div class="bg-white rounded-2xl p-6 shadow-sm border border-gray-200">
                    ...
                    <p class="text-sm text-gray-600">Students who log reflections at least 3 times a week show a 40%
                        higher
